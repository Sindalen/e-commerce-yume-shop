<x-layout>
    ...
    <div id="shop" class="mx-2 max-w-full select-none">
        <div>
            <div class="max-sm:text-2xl text-center text-[#51362e] pt-8 text-3xl font-semibold pb-4">Promotion</div>
                        ...
                        <div class="col-md-4">
                            <div class="cat-item image-zoom-effect">
                                ...
                                <div class="category-content">
                                    <div class="product_info product-button">
                                        <a href="\product" class="btn btn-common text-uppercase">Cute Dress Girls</a>
                                        <div class="flex justify-center font-bold">
                                            <div class="price text-[#fe4c50] text-[14px]">
                                                $5
                                                <span class="text-[12px] ml-[10px] text-[#b5aec4] line-through">10$</span>
                                            </div>
